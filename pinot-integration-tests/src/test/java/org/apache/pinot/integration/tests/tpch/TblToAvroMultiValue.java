...
public class TblToAvroMultiValue {
  ...
  private static final Map<String, String[]> TABLE_NAME_FIELDS_MAP = ImmutableMap.of(
      ...
      "customer", new String[]{
          "c_custkey", LONG_TYPE, "false",
          "c_name", STRING_TYPE, "true",
          "c_address", STRING_TYPE, "true",
          "c_nationkey", LONG_TYPE, "false",
          "c_phone", STRING_TYPE, "false",
          "c_acctbal", DOUBLE_TYPE, "false",
          "c_mktsegment", STRING_TYPE, "true",
          "c_comment", STRING_TYPE, "false"
      },
      // One example record:
      ...
      "lineitem", new String[]{
          "l_orderkey", LONG_TYPE, "false",
          "l_partkey", LONG_TYPE, "false",
          "l_suppkey", LONG_TYPE, "false",
          "l_linenumber", LONG_TYPE, "true",
          "l_quantity", LONG_TYPE, "true",
          "l_extendedprice", DOUBLE_TYPE, "true",
          "l_discount", DOUBLE_TYPE, "true",
          "l_tax", DOUBLE_TYPE, "false",
          "l_returnflag", STRING_TYPE, "false",
          "l_linestatus", STRING_TYPE, "false",
          "l_shipdate", STRING_TYPE, "false",
          "l_commitdate", STRING_TYPE, "false",
          "l_receiptdate", STRING_TYPE, "false",
          "l_shipinstruct", STRING_TYPE, "false",
          "l_shipmode", STRING_TYPE,  "false",
          "l_comment", STRING_TYPE, "false"
      },
      // One example record:
      ...
      "nation", new String[]{
          "n_nationkey", LONG_TYPE, "false",
          "n_name", STRING_TYPE, "true",
      ...
      "orders", new String[]{
          "o_orderkey", LONG_TYPE, "false",
          "o_custkey", LONG_TYPE, "false",
          "o_orderstatus", STRING_TYPE, "true",
          "o_totalprice", DOUBLE_TYPE, "true",
          "o_orderdate", STRING_TYPE, "false",
          "o_orderpriority", STRING_TYPE, "false",
          "o_clerk", STRING_TYPE, "true",
          "o_shippriority", LONG_TYPE, "true",
          "o_comment", STRING_TYPE, "true"
      },
      // One example record:
      ...
      "part", new String[]{
          "p_partkey", LONG_TYPE, "false",
          "p_name", STRING_TYPE, "true",
          "p_mfgr", STRING_TYPE, "true",
          "p_brand", STRING_TYPE, "true",
          "p_type", STRING_TYPE, "true",
          "p_size", LONG_TYPE, "true",
          "p_container", STRING_TYPE, "true",
          "p_retailprice", DOUBLE_TYPE, "true",
          "p_comment", STRING_TYPE , "true"
      },
      // One example record:
      ...
      "partsupp", new String[]{
          "ps_partkey", LONG_TYPE, "false",
          "ps_suppkey", LONG_TYPE, "false",
          "ps_availqty", LONG_TYPE, "true",
          "ps_supplycost", DOUBLE_TYPE, "true",
          "ps_comment", STRING_TYPE, "true"
      },
      // One example record:
      // {"r_regionkey":{"long":0},"r_name":{"string":"AFRICA"},"r_comment":{"string":"lar deposits. blithe"}}
      "region", new String[]{
          "r_regionkey", LONG_TYPE, "false",
          "r_name", STRING_TYPE, "true",
      ...
      "supplier", new String[]{
          "s_suppkey", LONG_TYPE, "false",
          "s_name", STRING_TYPE, "true",
          "s_address", STRING_TYPE, "true",
          "s_nationkey", LONG_TYPE, "false",
          "s_phone", STRING_TYPE, "true",
